...
<div class="container">
  ...
  <div class="form-row">
   ...
   <div class="form-group col-lg-7 @error('email') has-error  @enderror">
     ...
     <div class="radio">
     	<label>
     		<input type="radio" name="users_status" id="input" value="{{$users->users_status}}" checked="checked">
     		Hiện
     	</label>
     	<label>
     		<input type="radio" name="users_status" value="{{$users->users_status}}" id="input" >
     		Ẩn
