...
<a class="btn btn-primary" data-toggle="modal" href='#modal-file'><i class="glyphicon glyphicon-picture"></i></a>
  ...
  <div class="radio">
    <label>
      <input type="radio" name="slider_status"  value="1" <?php echo $sliders->slider_status == 1 ? "checked" : ''  ?> >
     Hiện
    </label>
     <label>
      <input type="radio" name="banner_status"  value="0" <?php echo $sliders->slider_status == 0 ? "checked" : ''  ?> >
    Ẩn
    </label>
  </div>
